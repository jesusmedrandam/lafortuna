...
export async function assertMedicationApplication(client, medicationId, routeId, unitId) {
    ...
    const medicine = (await client.query(`SELECT id_medicamento,nombre_comercial,id_unidad_predeterminada,dosis_sugerida,indicaciones
